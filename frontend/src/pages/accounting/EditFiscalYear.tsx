...
const EditFiscalYear = () => {
  ...
  const { handleUpdate, loading, isSuccess } = useUpdate({ queryKey: ['fiscal-years'] });
    ...
    <div className="container mx-auto py-6 space-y-6 max-w-4xl">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-foreground">{t('accounting.editFiscalYear')}</h1>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>{t('accounting.fiscalYearDetailsDescEdit', 'Update fiscal year information')}</CardDescription>
        </CardHeader>
