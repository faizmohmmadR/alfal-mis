...
const defaultForm: AccountCategoryFormData = {
  name: '',
  code: '',
  account_type: '',
  description: '',
...
const AddAccountCategory = () => {
  ...
  const [formData, setFormData] = useState<AccountCategoryFormData>(defaultForm);
    ...
    <div className="container mx-auto py-6 space-y-6 max-w-4xl">
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          <h1 className="text-base font-boldtext-sm">{t('accounting.addAccountCategory')}</h1>
        </div>
      </div>
