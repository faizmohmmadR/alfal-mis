...
const AddAccount = () => {
  ...
  const [formData, setFormData] = useState<AccountFormData>(defaultForm);
    ...
    <div className="container mx-auto py-6 space-y-6 max-w-4xl">
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          <h1 className="text-base font-boldtext-sm">{t('accounting.addAccount')}</h1>
        </div>
      </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={formData.parent === undefined ? '__none__' : formData.parent}
                  onValueChange={(value) => {
                    setFormData((prev) => ({ ...prev, parent: value === '__none__' ? undefined : value }));
                  }}
                >
                  <SelectTrigger>
