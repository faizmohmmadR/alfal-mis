...
const AddExpenseCategory = () => {
  ...
  const handleSubmit = () => {
    ...
    handleAdd({ ...formData, name: formData.name.trim() });
  };
    ...
    <div className="container mx-auto py-6 max-w-2xl">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-foreground">{t('expenses.categories.addCategory')}</h1>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>{t('expenses.categories.addCategoryDesc', 'Create a new expense category')}</CardDescription>
        </CardHeader>
