export const studentsFa = {
  ...
  bulkChangeClassLevel: "تغییر گروهی کلاس",
  selectNewClassLevel: "کلاس جدید",
  moveToClass: "انتقال دانشآموزان به",
  selectClassLevel: "انتخاب کلاس",
  changeSummary: "خلاصه تغییرات",
  totalSelected: "کل انتخاب شده",
  willChange: "تغییر خواهد کرد",
  alreadyInLevel: "قبلاً در این کلاس",
  targetLevel: "کلاس مقصد",
  applyChanges: "اعمال تغییرات",
  bulkUpdateSuccess: "کلاس بهروزرسانی شد",
  studentsUpdated: "دانشآموز بهروزرسانی شد",
  bulkUpdateFailed: "خطا در بهروزرسانی کلاسها",
  selectedStudents: "دانشآموزان انتخاب شده",
  currentClass: "کلاس فعلی",
  noStudentsSelected: "هیچ دانشآموزی انتخاب نشده. به لیست دانشآموزان برگردید و ابتدا دانشآموزان را انتخاب کنید.",
  backToList: "بازگشت به لیست دانشآموزان",
  alreadyAtLevel: "قبلاً در این سطح هستند",
  changeClassLevel: "تغییر کلاس",
  studentsSelected: "دانشآموز انتخاب شده",
  failedToLoadClassLevels: "خطا در بارگذاری کلاسها",
  ...
  noStudentsFound: "هیچ دانشآموزی یافت نشد",
  tryAdjustingSearch: "لطفاً عبارت جستجو خود را تغییر دهید",
  addFirstStudent: "برای شروع اولین دانشآموز خود را اضافه کنید",
  loadingStudents: "در حال بارگذاری دانشآموزان...",
