...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    ...
    >
      <PanelLeft />
      <span className="sr-onlytext-xs">Toggle Sidebar</span>
    </Button>
  )
})
...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      "absolute right-1 flex h-5 min-w-5 items-center justify-center rounded-md px-1 text-base font-medium tabular-nums text-sidebar-foreground select-none pointer-events-none",
